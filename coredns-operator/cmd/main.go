...
import (
	...
	"github.com/sharduljunagade/coredns-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f07c1500.sharduljunagade.github.io",
	...
	if err := (&controller.DNSMonitorReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "DNSMonitor")
		os.Exit(1)
	}
